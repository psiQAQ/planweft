...
- `$HOME/.claude/skills/project-docs-zht/SKILL.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/i18n/project-docs-zht/SKILL.md`

如果兩個路徑都不存在，請調用 program-design:project-docs 技能，並繼續以繁體中文工作。
