...
- `$HOME/.claude/skills/project-docs-zh/SKILL.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/i18n/project-docs-zh/SKILL.md`

如果两个路径都不存在，请调用 program-design:project-docs 技能，并继续用中文工作。
