...
This is the default loop prompt shipped by program-design v2.38.0 and later.
...
- If the plan was tampered with (attestation hash mismatch), the regular hooks already block injection; mention this and ask the user to re-run `/pd-plan-attest` before proceeding.
