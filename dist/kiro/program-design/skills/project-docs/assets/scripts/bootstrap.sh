#!/usr/bin/env sh
# Bootstrap program-design into the current workspace (idempotent).
# Run from the workspace root: sh .kiro/skills/project-docs/assets/scripts/bootstrap.sh
...
echo ""
echo "program-design (Kiro) — bootstrap"
