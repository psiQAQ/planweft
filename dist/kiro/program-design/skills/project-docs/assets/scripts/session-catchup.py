#!/usr/bin/env python3
"""
Session catchup for Kiro / program-design.
...
def main() -> None:
    ...
    if not found:
        print("[program-design] No planning files under .kiro/plan/. Run bootstrap first.")
        sys.exit(0)

    print("=" * 60)
    print("[program-design] SESSION CATCHUP REPORT")
