...
**Import as a workspace skill (optional):** Kiro → *Agent Steering & Skills* → *Import a skill* → choose this `program-design` folder ([Skills docs](https://kiro.dev/docs/skills/)).
