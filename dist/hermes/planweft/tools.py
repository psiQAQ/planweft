...
def planweft_status(cwd: str = "") -> str:
    project_dir = normalize_cwd(cwd)
...
def planweft_check_complete(cwd: str = "") -> str:
    ...
    if plan_dir is None:
        return json.dumps(
            {
                "ok": False,
                "error": "No task_plan.md found. Run planweft_init first.",
