export const PKG_NAME = "program-design";
export const CUSTOM_TYPE = "program-design";
...
export const CACHE_SAFE_REMINDER =
	"[program-design] Read task_plan.md for current phase and status. " +
...
export const PRE_TOOL_CACHE_SAFE_REMINDER =
	"[program-design] Before tool use, read task_plan.md for the active phase and constraints.";
...
export const TAMPERED_PREFIX = "[program-design] [PLAN TAMPERED — injection blocked]";
