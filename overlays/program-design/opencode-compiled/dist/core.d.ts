...
export declare const BANNER = "[program-design] ACTIVE PLAN \u2014 current state:";
export declare const REMINDER = "[program-design] Update progress.md with what you just did. If a phase is now complete, update task_plan.md status.";
