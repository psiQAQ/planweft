...
Install the package with the [Chinese guide](install/INSTALL.md) or the [English guide](install/INSTALL.en.md). Do not copy only `SKILL.md`, and do not merge directories made for different hosts.
