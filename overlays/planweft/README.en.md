...
Follow the [中文安装指南](install/INSTALL.md) or [English guide](install/INSTALL.en.md). Do not copy only `SKILL.md`, and do not merge directories made for different hosts.
