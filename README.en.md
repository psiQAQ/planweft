...
> PlanWeft 0.4.0-rc.5 is a release candidate. Stable 0.4.0 requires live acceptance on Codex, Claude Code, Pi, OpenCode and DSH. See the [release checklist](docs/releasing.en.md) / [中文](docs/releasing.md).
