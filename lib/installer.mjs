...
export class Installer {
  ...
  components(host, root, opt) {
    ...
    if (host === 'dsh') return [{source: path.join(root, 'dist/dsh/planweft/skills/project-docs'), target: skill}];
  ...
  preflight(host) {
    ...
    if (host === 'dsh' && !opt.skillOnly) throw Error('DSH currently supports --skill-only; native profile hooks await the official bridge dependencies');
