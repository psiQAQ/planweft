...
export class Installer {
  ...
  detectDuplicates(host, old) {
    ...
    for (const file of checks) {
      ...
      if (/planning-with-files|program-design|npm:planweft|["']planweft@|planweft-cli-|[/\\]planweft(?:[/\\"']|$)/.test(text)) throw Error(`Another planning registration may be active in ${file}; inspect it before installing`);
    }
  }
  preflight(host) {
