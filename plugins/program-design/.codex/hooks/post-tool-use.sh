#!/bin/bash
# program-design: Post-tool-use hook for Codex
...
echo "[program-design] Update progress.md with what you just did. If a phase is now complete, update task_plan.md status."
exit 0
