...
| R-22 [Python argparse](https://docs.python.org/3/library/argparse.html#exiting-methods) | Python Software Foundation / 文档贡献者 | [中文要点摘要](python-argparse.md) | PSF License；访问 2026-09-08；非全文翻译 | 已收录；入口参数校验 |
