...
Project overview: [中文](../README.md) / [English](../README.en.md) · Cross-platform design: [中文](platforms.md) / [English](platforms.en.md)

<!-- Generated from overlays/planweft/install/INSTALL.en.md; edit the source. -->

Commands target candidate RC12 and require confirming its publication in the official registry first. The local RC11 archive fixes RC10's Pi relative-source false positive; RC12 also fixes native BOM settings. These fixes do not prove the five-host model gates passed. Historical latest=RC1 is not a stable release. Known-source checks do not guarantee arbitrary custom-loader detection; updates do not remove other installation channels.
...
```bash
npx planweft@0.4.0-rc.12 add -a claude -a pi
npx planweft@0.4.0-rc.12 add -a codex --global
npx planweft@0.4.0-rc.12 add -a opencode --skill-only --symlink
npx planweft@0.4.0-rc.12 list
npx planweft@0.4.0-rc.12 doctor
npx planweft@0.4.0-rc.12 update -a pi
npx planweft@0.4.0-rc.12 remove -a pi
```
...
```bash
pi install -l npm:planweft@0.4.0-rc.12
...
```bash
npx planweft@0.4.0-rc.12 add -a dsh --global --dsh-profile headless
npx planweft@0.4.0-rc.12 doctor -a dsh --global
npx planweft@0.4.0-rc.12 update -a dsh --global
npx planweft@0.4.0-rc.12 remove -a dsh --global
```
...
```bash
dsh plugin --profile headless add planweft@0.4.0-rc.12
...
```bash
npx planweft@0.4.0-rc.12 add -a dsh --skill-only
npx planweft@0.4.0-rc.12 doctor -a dsh
npx planweft@0.4.0-rc.12 update -a dsh
npx planweft@0.4.0-rc.12 remove -a dsh
```
