...
The workflow uses Node 24 and npm 11.5.1+ without a persistent publish token. Validate OIDC with a candidate version.
...
cold-read evidence on Codex, Claude, Pi and OpenCode. Missing authentication, GUI or OS runs remain Not Run; synthetic responses
...
[PLAN-0008](plans/0008-planweft-release.md) (Chinese). Official store listings require separate host reviews.
