...
| 实施证据与长期状态改进 | [SoL-Pi 思想移植计划](plans/2026-09-17-sol-pi-state-management.md) | 待实现的 P0/P1 范围、数据契约、文件落点、恢复与评测、发布门禁及本地 Agent 启动指令；实施前先看[交付验证与基线问题](plans/2026-09-17-sol-pi-state-management-validation.md) |
